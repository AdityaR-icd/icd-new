    ...
    <>
      <footer>
            ...
            <div className="col-md-4 col-lg-3 col-xl-3">
              <div className="footer__talk-padding paddingLeft">
                ...
                <span className="footerText">
                  <p>
                    <strong>jobs</strong>&nbsp;
                    <a href={`mailto:${data?.job}}`}>{data?.job}</a>
                  </p>
                </span>
                <span className="footerText">
                  <p>
              ...
              <div className="paddingLeft footer__connect--wrapper">
                ...
                <div className="row footer__connect">
                  <div className="col-6 m-fl-right">
                    <span className="footerText facebook-link">
                      <p>
                        <a
                          href={data?.facebook}
                          target="_blank"
                    ...
                    <span className="footerText twitter-link">
                      <p>
                        <a
                          href={data?.twitter}
                          target="_blank"
                    ...
                    <span className="footerText linkedin-link">
                      <p>
                        <a
                          href={data?.linkedin}
                          target="_blank"
                  ...
                  <div className="col-6 m-fl-left">
                    <span className="footerText instagram-link">
                      <p>
                        <a
                          href={data?.instagram}
                          target="_blank"
                    ...
                    <span className="footerText vimeo-link">
                      <p>
                        <a
                          href={data?.vimeo}
                          target="_blank"
                    ...
                    <span className="footerText behance-link">
                      <p>
                        <a
                          href={data?.behance}
                          target="_blank"
          ...
          <div className="row  d-lg-block d-none">
            <div className="col-md-12">
              <span className="copyright">
                © 1990-{new Date().getFullYear()} itu chaudhuri design pvt ltd |
                all rights reserved. please note — no images or content from
                site can be reproduced without prior written consent from ICD
              </span>
            </div>
          </div>
        ...
        <div className="footer__connect d-lg-none d-block">
          <span className="footerText facebook-link">
            <a href={data?.facebook} target="_blank" rel="noreferrer noopener">
              facebook
            </a>
          </span>
          <span className="footerText twitter-link">
            <a href={data?.twitter} target="_blank" rel="noreferrer noopener">
              twitter
            </a>
          </span>
          <span className="footerText linkedin-link">
          ...
          <span className="footerText instagram-link">
            <a href={data?.instagram} target="_blank" rel="noreferrer noopener">
              instagram
            </a>
          </span>
          <span className="footerText vimeo-link">
            <a href={data?.vimeo} target="_blank" rel="noreferrer noopener">
              vimeo
            </a>
          </span>
          <span className="footerText behance-link">
            <a href={data?.behance} target="_blank" rel="noreferrer noopener">
              behance
            </a>
          </span>
        </div>
