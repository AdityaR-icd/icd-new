        ...
        >
            ...
            <div className="col-md-12">
              <span className="applying__for">
                ...
                <span className="font__red">
                  ...
                  >
                    <option data-mail={dataEmail} value="Branding">
                      Branding
                    </option>
                    <option data-mail={dataEmail} value="Packaging Design">
                      Packaging Design
                    </option>
                    <option data-mail={dataEmail} value="UX/UI Projects">
                      UX/UI Projects
                    </option>
                    <option data-mail={dataEmail} value="Editorial Design">
                      Editorial Design
                    </option>
                    <option
                      data-mail={dataEmail}
                    ...
                    <option
                      data-mail={dataEmail}
                      value="App/New Product Design"
                    >
                      App/New Product Design
                    </option>
                    <option data-mail={dataEmail} value="Others">
                      Others
                    </option>
                  </select>
            ...
            <div className="col-lg-6">
              <div className="form-group">
                <input
                  ...
                  required
                />
                <label className="form-control-placeholder" htmlFor="company">
                  your company *
                </label>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="form-group">
                <input
                  ...
                  required
                />
                <label className="form-control-placeholder" htmlFor="emailId">
                  your email *
                </label>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="form-group">
                <input
                  ...
                  required
                />
                <label className="form-control-placeholder" htmlFor="mobile-no">
                  your mobile number *
                </label>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="form-group">
                <input
                  ...
                  required
                />
                <label className="form-control-placeholder" htmlFor="website">
                  your company website url (like example.com) *
                </label>
              </div>
            </div>
            <div className="col-lg-6">
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <div className="message error-message font__red">
