...
export default function Enquiry({ position }) {
  ...
  const options = position.map((data, index) => {
    if (index == 0) {
      return (
        <option value={data[0]} data-mail={data[1]} selected>
          {data[0]}
        </option>
      );
    } else {
      return (
        <option value={data[0]} data-mail={data[1]}>
          {data[0]}
        </option>
      );
    }
            ...
            <div className="col-lg-6">
              <div className="form-group">
                <input
                  ...
                  required
                />
                <label className="form-control-placeholder" htmlFor="last-name">
                  your surname *
                </label>
              </div>
            </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="form-group">
                ...
                <label
                  className="form-control-placeholder"
                  htmlFor="UGCollegeName"
                >
                  your undergraduate college name and location *
                </label>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="form-group">
                ...
                >
                  your post graduate college name and location *
                </label>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="form-group">
                <input
                  ...
                  autoComplete="off"
                  value={lastOffice}
                  onChange={(e) => setlastOffice(e.target.value)}
                  required
                />
                <label
                  className="form-control-placeholder"
            ...
            <div className="col-lg-6">
              <div className="form-group">
                <input
                  ...
                  required
                />
                <label className="form-control-placeholder" htmlFor="city">
                  your current city *
                </label>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="form-group">
                ...
                <label className="form-control-placeholder" htmlFor="website">
                  your website/behance/linkedin url (like example.com)*
                </label>
              </div>
            </div>
          </div>
