  ...
  return (
    <div>
      <form
        ...
        method="POST"
        action="https://a6f6a24b.sibforms.com/serve/MUIEADiDSmHjT9afNf-PzgCgWsau7TkVZSO86tS2jMasQzX1k-xTv25YrkndeW2CSUQ7-yuvRRJ0uKy-BF3km-KAv5vj1s-Vww4KNEE7N3jzfkzbToN1fn-8C2W0qKvHRMyQsZVB5JVNDs32ERczKkCLMQbAyFD6xSWbUsGW9t7Rejlsrkb1wGyvdX1b8orKjZ7Yr1c1CKjmiktF"
      >
        ...
        <div
          ...
          id="sib-captcha"
          data-sitekey="6LceABgnAAAAAIm51-3MRr9ruU_VWmfs1OfAfh9z"
          data-callback="handleCaptchaResponse"
        ></div>
        <button
          type="submit"
          form="sib-form"
          className={btn ? ` blackBG ` : "blackBG disable"}
        >
          subscribe
        </button>
      </form>
