        ...
        (industry) => (
          ...
          (
            <div key={industry.id}>
              <section
                className={
                  idMatch == industry.slug ? expandsectionClass : sectionClass
                }
                id={industry.slug}
              >
                <div className="container">
                  <div className="row">
                    <div className="col-md-12">
                      <span className={type.project__category}>
                        {industry.name}
                      </span>
                      {projectLength > 3 && (
                        <>
                          <span
                            className={`d-md-block d-none ${industries.project__category__seeAll}`}
                          >
                            <span
                              className="see-all"
                              onClick={() => toggleClass(industry.slug)}
                            >
                              <span className={industries.expand_btn}></span>
                              {idMatch == industry.slug
                                ? "less " + industry.name
                                : "more " + industry.name}
                            </span>
                          </span>
