  ...
  return (
    <>
      {nodes.map(({ projects }, i, types) => (
        <section
          className={`${type.industry__filter}  ${type.projectType__filter}`}
        >
          <div className={` container ${type.container}`}>
            <div className="row">
              <div className="col-12">
                ...
                <a
                  className={`${type.see_all} see-all`}
                  href={`/projects/category/${types[i].slug}`}
                >
                  see all
                </a>
              </div>
                                    ...
                                    >
                                      ...
                                      {leadImgSrc.includes("mp4") && (
                                        <video autoPlay muted loop playsInline>
                                          <source
                                            src={leadImgSrc.replace(
                                              "fl_progressive,q_auto,dpr_auto,f_auto/f_auto,q_auto/",
                                              "",
                                            )}
                                            type="video/mp4"
                                          />
