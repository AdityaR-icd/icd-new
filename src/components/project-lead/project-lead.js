                        ...
                        <div className={`${style.textContainer} container`}>
                          <div className="row">
                            <div className="col-md-10 offset-md-1">
                              <div
                                className={`${intro.textContent} ${style.introText} ${intro.homeLeadText}`}
                              >
                                <span className={`${style.homeText}`}>
                                  {node?.featuredtext[i]?.content &&
                      ...
                      <div className="col-md-12">
                        ...
                        >
                            ...
                            <div className={styles.Tilt}>
                              <div className="Tilt-inner">
                                {project_video && (
                                  <>
                                    <div
                                      className={`${styles.project__leadimage}  d-none d-lg-block ${styles.video_container}`}
                                    >
                                      <video
                                        src={`${project_video}#t=0.02`}
                                        autoPlay
                                        playsInline
                                        loop
                                        muted
                                ...
                                {!project_video && (
                                  <>
                                    <div
                                      className={` d-none d-lg-block ${styles.project__leadimage}`}
                                    >
                                      <Image
                                        priority={true}
                                        placeholder="blur"
                                ...
                                <div
                                  className={` d-lg-none d-block ${styles.project__leadimage}`}
                                >
                                  <Image
                                    priority={true}
                                    placeholder="blur"
                              ...
                              {projects[j]?.projectComponent
                                ?.awardsReceived && (
                                <span
                                  className={`${styles.project__tag} project__tag`}
                                >
                                  winner
                                </span>
                              )}
                              {projects[j]?.id == common[0] && (
                                <span
                                  className={`${styles.project__tag} ${styles.new_tag} project__tag`}
                                >
                                  new
                                </span>
                              )}
                          ...
                          <div className={`${styles.project__name}`}>
                            ...
                            <span
                              className={`font__grey ${styles.project__type}`}
                            >
                              {" "}
                              / {client}
                            </span>
