...
async function fetchAPI(query, { variables } = {}) {
  ...
  const headers = { 'Accept': '*/*', 'Content-Type': 'application/json', 'User-Agent': '*', 'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczpcL1wvZGlnaXRhbC5pY2RpbmRpYS5jb20iLCJpYXQiOjE2ODE5OTE4MTYsIm5iZiI6MTY4MTk5MTgxNiwiZXhwIjozMzIxNzk5MTgxNiwiZGF0YSI6eyJ1c2VyIjp7ImlkIjoiMSJ9fX0.K2vTfySmMsdzXY3tuNAQfpXmTCD8RzymrL08qifJ-JA' };
    ...
    `
    {
      projectTypes(where: {slug: "${slug}" , parent: 0 ,orderby: TERM_ID }) {
        edges {
          node {
            slug
            children(where: {slug: "${sub_slug}"} , first: 100) {
              edges {
                node {
                  projects {
                    edges {
