            ...
            <div className="col-md-6 col-lg-4">
                <div className="job-cont">
                    <span className="position">
                        <Image placeholder="blur" property blurDataURL="data:image/jpeg;base64,"  src={profileImage} alt={data.title} layout="fill"/>
                    </span>
