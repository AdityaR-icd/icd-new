    ...
    return (
        <div className={`col-md-6 col-lg-4 ${style.servicesItem}`}>
            <span className={style.serviceLogo}>
                <span>
                    <Image placeholder="blur" blurDataURL={`data:image/svg+xml;base64,${toBase64(shimmer(700, 475))}`} className={style.serviceLogo__anim} src={cardGifImgSrc} fill alt="" />
                    <Image placeholder="blur" blurDataURL={`data:image/svg+xml;base64,${toBase64(shimmer(700, 475))}`} className={style.serviceLogo__static} src={cardImgSrc} fill alt="" />
                </span>
            </span>
