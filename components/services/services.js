...
export default function service({ meta , edges , other_service }){
    ...
    return(
        ...
        <NextSeo
            ...
            canonical="https://icd-v3-vercel.vercel.app/services"
            robots={meta.metaRobotsNoindex}
            googlebot={meta.metaRobotsNofollow}
            openGraph={{
                url: 'https://icd-v3-vercel.vercel.app/services',
                title: meta.seo.title,
                description: meta.seo.metaDesc,
                images: [
                {
      ...
      <Head>
        ...
        <meta name="twitter:url" content="https://icd-v3-vercel.vercel.app/services" />
