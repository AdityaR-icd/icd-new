            ...
            <div className="container page__header--container">
              <div className="row">
                ...
                <div className="col-12 col-md-8 page__header--nav bottom__align nav__subPage">
                    <Link href={`/`}> 
                        <a className={ `${style.project__filter} project__filter marginRight ${style.active}`}>team</a>
                    </Link>
                    <Link href={`/careers`}> 
                        <a className={ `${style.project__filter} project__filter marginRight`}>careers</a>
                    </Link>
                </div>
              </div>
