                                ...
                                <div style={{borderTop: '0px solid transparent', borderLeft: '0px solid transparent', borderBottom: '0px solid transparent', borderRight: '0px solid transparent', paddingTop: 35, paddingBottom: 5, paddingRight: 0, paddingLeft: 0}}>
                                  <div className="mobile_hide">
                                    <div align="right" className="img-container right autowidth" style={{paddingRight: 0, paddingLeft: 0}}>
                                      <a href="https://www.icdindia.com" tabIndex={-1} target="_blank"> <img priority decoding="async" align="right" alt="Image" border={0} className="right autowidth" src="http://icdlabs.in/icd-blog/wp-content/themes/kotha/assets/images/logo_red_dek.png" style={{textDecoration: 'none', msInterpolationMode: 'bicubic', height: 'auto', border: 'none', width: '100%', maxWidth: 172, float: 'none', display: 'block'}} title="Image" width={172} /></a>
                                    </div>
                                  </div>
                                  <div className="desktop_hide mobile-logo" style={{msoHide: 'all', display: 'none', maxHeight: 0, overflow: 'hidden'}}>
                                    <div align="right" className="img-container right autowidth" style={{paddingRight: 0, paddingLeft: 0}}>
                                      <img priority alt='icd-icon' decoding="async" align="right" border={0} className="right autowidth" src={Mobilelogo.src} style={{textDecoration: 'none', msInterpolationMode: 'bicubic', border: 0, height: 'auto', width: '100%', maxWidth: 54, float: 'none', display: 'block'}} title="Image" width={54} />
                                    </div>
                                  </div>
                                </div>
                              </div>
                                  ...
                                  <div style={{ borderTop: '0px solid transparent', borderLeft: '0px solid transparent', borderBottom: '0px solid transparent', borderRight: '0px solid transparent', paddingTop: 5, paddingBottom: 5, paddingRight: 0, paddingLeft: 0 }}>
                                    ...
                                    <div className="article-headline" style={{ color: '#171717', fontFamily: 'Merriweather,Times,Times New Roman,serif', lineHeight: '1.2', paddingTop: 0, paddingRight: 20, paddingBottom: 15, paddingLeft: 20 }}>
                                      <div style={{ fontFamily: 'Merriweather,Times,Times New Roman,serif', fontSize: 12, lineHeight: '1.2', color: '#171717', msoLineHeightAlt: 14 + 'px' }}>
                                        <p className='newsarticle-heading' style={{ fontSize: 28, lineHeight: '1.2', margin: 0, msoLineHeightAlt: 34, margin: '0px !importatnt' }}>
                                          ...
                                          <table className="social-icons" activate="activate" align="left" alignment="alignment" cellPadding={0} cellSpacing={0} role="presentation" style={{tableLayout: 'fixed', verticalAlign: 'top', borderSpacing: 0, borderCollapse: 'undefined', msoTableTspace: 0, msoTableRspace: 0, msoTableBspace: 0, msoTableLspace: 0}} to="to" valign="top">
                                            <tbody>
                                              <tr align="left" style={{verticalAlign: 'top', display: 'inline-block', textAlign: 'left'}} valign="top">
                                                <td style={{wordBreak: 'break-word', verticalAlign: 'top', paddingBottom: 18, paddingRight: 30}} valign="top"><a href="https://www.facebook.com/ItuChaudhuriDesign/" target="_blank"><img priority decoding="async" alt="Facebook" height={32} src="http://icdlabs.in/ylp/images/facebook@2x.png" style={{textDecoration: 'none', msInterpolationMode: 'bicubic', height: 'auto', border: 'none', display: 'block'}} title="Facebook" width={32} /></a></td>
                                                <td style={{wordBreak: 'break-word', verticalAlign: 'top', paddingBottom: 18, paddingRight: 30}} valign="top"><a href="https://twitter.com/icdindia" target="_blank"><img priority decoding="async" alt="Twitter" height={32} src="http://icdlabs.in/ylp/images/twitter@2x.png" style={{textDecoration: 'none', msInterpolationMode: 'bicubic', height: 'auto', border: 'none', display: 'block'}} title="Twitter" width={32} /></a></td>
                                                <td style={{wordBreak: 'break-word', verticalAlign: 'top', paddingBottom: 18, paddingRight: 30}} valign="top"><a href="https://www.instagram.com/ituchaudhuridesign" target="_blank"><img priority decoding="async" alt="Instagram" height={32} src="http://icdlabs.in/ylp/images/instagram@2x.png" style={{textDecoration: 'none', msInterpolationMode: 'bicubic', height: 'auto', border: 'none', display: 'block'}} title="Instagram" width={32} /></a></td>
                                              </tr>
                                            </tbody>
                                          </table>
                                          <table className="social-icons" activate="activate" align="left" alignment="alignment" cellPadding={0} cellSpacing={0} role="presentation" style={{tableLayout: 'fixed', verticalAlign: 'top', borderSpacing: 0, borderCollapse: 'undefined', msoTableTspace: 0, msoTableRspace: 0, msoTableBspace: 0, msoTableLspace: 0}} to="to" valign="top">
                                            <tbody>
                                              <tr align="left" style={{verticalAlign: 'top', display: 'inline-block', textAlign: 'left'}} valign="top">
                                                <td style={{wordBreak: 'break-word', verticalAlign: 'top', paddingBottom: 18, paddingRight: 30}} valign="top"><a href="https://www.linkedin.com/company/itu-chaudhuri-design" target="_blank"><img priority decoding="async" alt="LinkedIn" height={32} src="http://icdlabs.in/ylp/images/twitter@2x.png" style={{textDecoration: 'none', msInterpolationMode: 'bicubic', height: 'auto', border: 'none', display: 'block'}} title="LinkedIn" width={32} /></a></td>
                                                <td style={{wordBreak: 'break-word', verticalAlign: 'top', paddingBottom: 18, paddingRight: 30}} valign="top"><a href="https://www.behance.net/ituchaudhuridesign" target="_blank"><img priority decoding="async" alt="Behance" height={32} src="http://icdlabs.in/ylp/images/behance-new.png" style={{textDecoration: 'none', msInterpolationMode: 'bicubic', height: 'auto', border: 'none', display: 'block'}} title="Custom" width={32} /></a></td>
                                                <td style={{wordBreak: 'break-word', verticalAlign: 'top', paddingBottom: 18, paddingRight: 30}} valign="top"><a href="https://www.icdindia.com" target="_blank"><img priority decoding="async" alt="icd-v3-vercel.vercel.app" height={32} src="http://icdlabs.in/ylp/images/icd-new.png" style={{textDecoration: 'none', msInterpolationMode: 'bicubic', height: 'auto', border: 'none', display: 'block'}} title="Custom" width={32} /></a></td>
                                              </tr>
                                            </tbody>
                                          </table>
                                        </td>
                                ...
                                <div style={{borderTop: '0px solid transparent', borderLeft: '0px solid transparent', borderBottom: '0px solid transparent', borderRight: '0px solid transparent', paddingTop: 5, paddingBottom: 5, paddingRight: 0, paddingLeft: 0}}>
                                  <div className="subscribe-cont" style={{color: '#171717', fontFamily: '-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen-Sans,Ubuntu,Cantarell,Helvetica Neue,sans-serif', lineHeight: '1.2', paddingTop: 10, paddingRight: 10, paddingBottom: 10, paddingLeft: 10}}>
                                    <div style={{fontFamily: 'Merriweather,Times,Times New Roman,serif', fontSize: 12, lineHeight: '1.2', color: '#171717', msoLineHeightAlt: 14}}>
                                      <p style={{fontSize: 12, lineHeight: 18+'px', msoLineHeightAlt: 17, margin: 0}}>You are receiving this newsletter because you have subscribed or have been recommended by a friend. If you'd like to add new subscribers, please click <a href="https://www.icdindia.com/newsletter-subscription/">here</a>. And to unfollow, please click on the unsubscribe link below.</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
